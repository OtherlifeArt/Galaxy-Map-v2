...
JQ_POINT_OBFUSCATE_FILTER='
  # 1. Define the translation map
  {
    ...
    "NOTES": "51",
    "INTERESTING (move to 2nd to last position)": "52",
    "URLS (sources)": "53",
    "CONJECTURAL_NAME": "54",
    "CONJECTURAL_TYPE": "55",
    "PLACEMENT_CERT": "56",
...
JQ_POLYGON_OBFUSCATE_FILTER='
  # 1. Define the translation map
  {
    ...
    "KNOWN_CLIMATES": "46",
    "KNOWN_ATMOSPHERE": "47",
    "KNOWN_SURFACE_WATER": "48",
    "KNOWN_RESOURCES": "49",
    "KNOWN_EXPORTS": "50",
    "KNOWN_IMPORTS": "51",
    "POINTS_OF_INTEREST: "52",
    "LENGTH_OF_DAY": "53",
    "LENGTH_OF_YEAR": "54",
    "CAPITAL": "55",
    "STARPORTS": "56",
...
jq -c -s "$JQ_OBFUSCATE_FILTER" "$GEO_ASTRO_OBJ_SRC"/SW_Map_*.geojson > "$GEO_ASTRO_OBJ_DIST"/combined.min.geojson &
